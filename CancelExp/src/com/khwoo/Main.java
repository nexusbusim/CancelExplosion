...
public class Main extends JavaPlugin{
	...
	public void onEnable() {
		...
		config.addDefault("en.onEnable", "CancelExplosion Enabled, version : 0.0.5"); // .onEnable
		config.addDefault("en.onDisable", "CancelExplosion Disabled"); // .onDisable
		config.addDefault("en.version", "Current version : 0.0.5 CancelExplosion"); // version information
		...
		config.addDefault("ko.onEnable", "폭발 방지 플러그인 실행, 버전 : 0.0.5"); // .onEnable
		config.addDefault("ko.onDisable", "폭발 방지 플러그인 종료"); // .onDisable
		config.addDefault("ko.version", "버전 : 0.0.5 폭발방지"); // version information
